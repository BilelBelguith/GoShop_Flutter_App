...
class RegisterShopOwner extends StatefulWidget {
  const RegisterShopOwner({Key? key}) : super(key: key);


  @override
  State<RegisterShopOwner> createState() => _RegisterShopOwnerState();
}

class _RegisterShopOwnerState extends State<RegisterShopOwner> {
